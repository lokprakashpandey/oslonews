...
--
-- Host: localhost
-- Generation Time: Jan 02, 2016 at 06:01 PM
...
(1, 'Return of Opposition in South Sudan an important step: Minister of Foreign Affairs Børge Brende.', 'Dec 23, Oslo: Today, representatives of the opposition returned to the South Sudanese capital, Juba, for the first time since the conflict in South Sudan broke out in December 2013. ''This is a long-awaited and important step on the path to peace in South Sudan,'' said Minister of Foreign Affairs Børge Brende.\r\nIn August, the Government and the opposition in South Sudan signed a peace agreement that aimed to bring an end to nearly two years of conflict. Both parties declared a ceasefire immediately after the signing. Despite this, hostilities have continued. Together with the US, Norway has played an active role in securing the return of the opposition.', 'test', 1, '2016-01-02 10:44:01', '2016-01-02 10:44:01', 1, 0, 'return-of-opposition-in-south-sudan-an-important-step-minister-of-foreign-affairs-borge-brende', 2);
